export class Players {
    ...
    public static get LAVENDER() {return Player(19)};
    public static get COAL() {return Player(20)};
    ...
    public static get NEUTRAL_HOSTILE() {return Player(24)};
    public static get NEUTRAL_PASSIVE() {return Player(25)};
    public static get NEUTRAL_VICTIM() {return Player(26)};
    public static get NEUTRAL_EXTRA() {return Player(27)};
}